...
)
{
    ...
    if (history != NULL)
    {
        ...
        if (cumulativeMode)
        {
            fprintf(history, "Damage Model      : IP_n = IP_0 * exp(-gamma * n)\n");
...
static void runPart1BSimulation1(int cumulativeMode)
{
    ...
    mode = cumulativeMode
        ? "PART 2-C - PART 1-C / PART 1-B SIMULATION 1"
        : "PART 2-C - PART 1-B SIMULATION 1";
...
static void runPart1BSimulation2(int cumulativeMode)
{
    ...
    baselineMode = cumulativeMode
        ? "PART 2-C - PART 1-C / PART 1-B SIMULATION 1 BASELINE"
        : "PART 2-C - PART 1-B SIMULATION 1 BASELINE";

    jammedMode = cumulativeMode
        ? "PART 2-C - PART 1-C / PART 1-B SIMULATION 2"
        : "PART 2-C - PART 1-B SIMULATION 2";

    initialMode = cumulativeMode
        ? "PART 2-C - PART 1-C / PART 1-B SIMULATION 2 COMPARISON"
        : "PART 2-C - PART 1-B SIMULATION 2 COMPARISON";

    comparisonTitle = cumulativeMode
        ? "PART 2-C / PART 1-C - SIMULATION COMPARISON"
        : "PART 2-C - SIMULATION COMPARISON";
...
{
    printSection("PART 2-C - SELECT SIMULATION");

    printf("\n");
    printf("B and E impact powers degrade after every firing.\n");
    printf("IP_n = IP_0 * exp(-gamma * n)\n\n");
    printf("1. Redo Part 1-C / Part 1-A\n");
    printf("2. Redo Part 1-C / Part 1-B Simulation 1\n");
    printf("3. Redo Part 1-C / Part 1-B Simulation 2\n");
