...
static void showSetupHelp(void)
{
    ...
    printf("  2. B and E reload times\n");
    printf("  3. Gamma values for all B and E ship types\n");
    ...
    printf("\nPart 2-C uses IP_n = IP_0 * exp(-gamma * n).\n");
    printf("Damage, firing counts and the current impact factor\n");
    printf("of every ship are displayed or saved in the results.\n");
...
static void showInputHelp(void)
{
    ...
    printf("Reload times and gamma values accept decimal numbers.\n");
