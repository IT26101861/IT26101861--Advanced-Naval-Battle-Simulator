...
static void showSetupHelp(void)
{
    ...
    printf("  2. Battleship reload time T_B\n");
    printf("  3. Reload time T_E for EA, EB, EC, ED and EE\n");
    printf("  4. Shell velocity and battlefield size\n");
    printf("  5. Escort count and Battleship position\n");
    printf("  6. Random number generator seed\n");

    printf("\nPart 2-B keeps B's threat-first attack order and lets\n");
    printf("every surviving Escort fire continuously using its\n");
    printf("type-specific reload interval.\n");
...
static void showInputHelp(void)
{
    ...
    printf("\n");
    printf("Menu, count, coordinate and seed inputs use whole numbers.\n");
    printf("Reload times accept decimal numbers in their shown ranges.\n");

    printf("\n");
    printf("Examples:\n");
    printf("  Valid   : 1, 2, 25, 100\n");
    printf("  Invalid : abc, 20abc, @#$\n");
