...
static void showSetupHelp(void)
{
    ...
    printf("  3. Battleship maximum shell velocity\n");
    printf("  4. Battlefield / canvas size\n");
    printf("  5. Number of Escort Ships and B position\n");
    printf("  6. Random number generator seed\n");

    printf("\nPart 2-A fires B's single gun sequentially. Targets\n");
    printf("are ordered using a threat-first strategy, and the\n");
    printf("attack order is displayed and saved for every step.\n");
...
static void showInputHelp(void)
{
    ...
    printf("Reload time accepts a decimal number in its shown range.\n");
