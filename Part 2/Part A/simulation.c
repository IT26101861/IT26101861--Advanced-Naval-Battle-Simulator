...
static void determineShotsForCurrentPoint(int cumulativeMode)
{
    ...
    for (i = 0; i < numberOfEscorts; i++)
    {
        ...
        if (cumulativeMode && escorts[i].hasFired)
            continue;
...
)
{
    ...
    *sinkTime = -1.0;
    ...
    while (1)
    {
        ...
        lastEImpactTime = escorts[selected].eImpactTime;

        if (battleshipDamage >= DESTROYED_DAMAGE - 0.0000001)
        {
            battleshipAlive = 0;
            *sinkerIndex = selected;
            *sinkTime = escorts[selected].eImpactTime;
        }
    }
...
static void runPart1BSimulation1(int cumulativeMode)
{
    ...
    mode = cumulativeMode
        ? "PART 2-A - PART 1-C / PART 1-B SIMULATION 1"
...
static void runPart1BSimulation2(int cumulativeMode)
{
    ...
    baselineMode = cumulativeMode
        ? "PART 2-A - PART 1-C / PART 1-B SIMULATION 1 BASELINE"
        : "PART 2-A - PART 1-B SIMULATION 1 BASELINE";

    jammedMode = cumulativeMode
        ? "PART 2-A - PART 1-C / PART 1-B SIMULATION 2"
        : "PART 2-A - PART 1-B SIMULATION 2";

    initialMode = cumulativeMode
        ? "PART 2-A - PART 1-C / PART 1-B SIMULATION 2 COMPARISON"
        : "PART 2-A - PART 1-B SIMULATION 2 COMPARISON";

    comparisonTitle = cumulativeMode
        ? "PART 2-A / PART 1-C - SIMULATION COMPARISON"
        : "PART 2-A - SIMULATION COMPARISON";
...
{
    printSection("PART 2-A - SELECT SIMULATION");

    printf("\n");
    printf("B uses one gun, a user-defined reload time and threat-first attack order.\n\n");
